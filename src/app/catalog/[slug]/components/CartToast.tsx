...
export default function CartToast({ toast, onClose }: CartToastProps) {
  return (
    <div className={`fixed top-6 left-1/2 -translate-x-1/2 z-200 transition-all duration-300 ${
      ...
      <div className="flex items-center gap-3 bg-opora-brown text-white pl-6 pr-4 py-3 rounded-full shadow-lg text-sm font-medium whitespace-nowrap">
        ...
        <button onClick={onClose} className="opacity-70 hover:opacity-100 transition-opacity" aria-label="Закрити">
